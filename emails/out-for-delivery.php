...
// Create preview text
$previewText = empty($emailData['email']['preview_text']) ? 'Exciting news! Your order #' . $emailData['order']['number'] . ' is out for delivery today. Keep an eye out for your package. Estimated delivery: ' . $emailData['order']['estimated_delivery'] . '.' : $emailData['email']['preview_text'];

// Generate the email content
$emailContent = renderDocumentStart('Your Order Is Out For Delivery!', $previewText);

// Add header
$emailContent .= renderHeader('Your Order Is Out For Delivery!');
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="content" style="padding: 0 20px;">
        ...
        <p>Great news! Your order is on its way and will be arriving soon.</p>
        <p>Keep an eye out for your delivery, and if you need to track its progress, you can do so using the link below.</p>
      </td>
    </tr>
  </table>';
